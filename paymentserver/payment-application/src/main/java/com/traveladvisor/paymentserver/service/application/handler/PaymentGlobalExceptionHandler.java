package com.traveladvisor.paymentserver.service.application.handler;
...
public class PaymentGlobalExceptionHandler extends GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleException(PaymentApplicationServiceException ex, WebRequest webRequest) {
        log.error("[Payment Domain] 예외가 발생했습니다. 내용은 다음과 같습니다.", ex);
