package com.traveladvisor.carserver.service.domain.outbox.model;
...
/**
 * Car 서비스에서 Booking 서비스로 메시지를 보내기 위한 outbox 테이블입니다.
 */
@Getter @Builder
@AllArgsConstructor
public class BookingOutbox {
    ...
    private CarBookingApprovalStatus bookingStatus;
    @Setter
