 ...
 */
package debezium.hotel.booking_outbox;
...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5261396735839004213L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Envelope\",\"namespace\":\"debezium.hotel.booking_outbox\",\"fields\":[{\"name\":\"before\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"Value\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"saga_action_id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Uuid\"}},{\"name\":\"event_type\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"event_payload\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.data.Json\"}},{\"name\":\"booking_status\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.parameters\":{\"allowed\":\"HOTEL_BOOKED,HOTEL_CANCELLED\"},\"connect.name\":\"io.debezium.data.Enum\"}},{\"name\":\"outbox_status\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.parameters\":{\"allowed\":\"STARTED,COMPLETED,FAILED\"},\"connect.name\":\"io.debezium.data.Enum\"}},{\"name\":\"created_at\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.default\":\"1970-01-01T00:00:00.000000Z\",\"connect.name\":\"io.debezium.time.ZonedTimestamp\"},\"default\":\"1970-01-01T00:00:00.000000Z\"},{\"name\":\"updated_at\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.ZonedTimestamp\"}],\"default\":null},{\"name\":\"completed_at\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.name\":\"io.debezium.time.ZonedTimestamp\"}],\"default\":null},{\"name\":\"version\",\"type\":\"int\"}],\"connect.name\":\"debezium.hotel.booking_outbox.Value\"}],\"default\":null},{\"name\":\"after\",\"type\":[\"null\",\"Value\"],\"default\":null},{\"name\":\"source\",\"type\":{\"type\":\"record\",\"name\":\"Source\",\"namespace\":\"io.debezium.connector.postgresql\",\"fields\":[{\"name\":\"version\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"connector\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"name\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"ts_ms\",\"type\":\"long\"},{\"name\":\"snapshot\",\"type\":[{\"type\":\"string\",\"avro.java.string\":\"String\",\"connect.version\":1,\"connect.parameters\":{\"allowed\":\"true,last,false,incremental\"},\"connect.default\":\"false\",\"connect.name\":\"io.debezium.data.Enum\"},\"null\"],\"default\":\"false\"},{\"name\":\"db\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"sequence\",\"type\":[\"null\",{\"type\":\"string\",\"avro.java.string\":\"String\"}],\"default\":null},{\"name\":\"schema\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"table\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"txId\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"lsn\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"xmin\",\"type\":[\"null\",\"long\"],\"default\":null}],\"connect.name\":\"io.debezium.connector.postgresql.Source\"}},{\"name\":\"op\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"ts_ms\",\"type\":[\"null\",\"long\"],\"default\":null},{\"name\":\"transaction\",\"type\":[\"null\",{\"type\":\"record\",\"name\":\"block\",\"namespace\":\"event\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"total_order\",\"type\":\"long\"},{\"name\":\"data_collection_order\",\"type\":\"long\"}],\"connect.version\":1,\"connect.name\":\"event.block\"}],\"default\":null}],\"connect.version\":1,\"connect.name\":\"debezium.hotel.booking_outbox.Envelope\"}");
  ...
  private debezium.hotel.booking_outbox.Value before;
  private debezium.hotel.booking_outbox.Value after;
   ...
   */
  public Envelope(debezium.hotel.booking_outbox.Value before, debezium.hotel.booking_outbox.Value after, io.debezium.connector.postgresql.Source source, java.lang.String op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (debezium.hotel.booking_outbox.Value)value$; break;
    case 1: after = (debezium.hotel.booking_outbox.Value)value$; break;
   ...
   */
  public debezium.hotel.booking_outbox.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(debezium.hotel.booking_outbox.Value value) {
    this.before = value;
  }
   ...
   */
  public debezium.hotel.booking_outbox.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(debezium.hotel.booking_outbox.Value value) {
    this.after = value;
  }
   ...
   */
  public static debezium.hotel.booking_outbox.Envelope.Builder newBuilder() {
    return new debezium.hotel.booking_outbox.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static debezium.hotel.booking_outbox.Envelope.Builder newBuilder(debezium.hotel.booking_outbox.Envelope.Builder other) {
    if (other == null) {
      return new debezium.hotel.booking_outbox.Envelope.Builder();
    } else {
      return new debezium.hotel.booking_outbox.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static debezium.hotel.booking_outbox.Envelope.Builder newBuilder(debezium.hotel.booking_outbox.Envelope other) {
    if (other == null) {
      return new debezium.hotel.booking_outbox.Envelope.Builder();
    } else {
      return new debezium.hotel.booking_outbox.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private debezium.hotel.booking_outbox.Value before;
    private debezium.hotel.booking_outbox.Value.Builder beforeBuilder;
    private debezium.hotel.booking_outbox.Value after;
    private debezium.hotel.booking_outbox.Value.Builder afterBuilder;
    private io.debezium.connector.postgresql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(debezium.hotel.booking_outbox.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = debezium.hotel.booking_outbox.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = debezium.hotel.booking_outbox.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(debezium.hotel.booking_outbox.Envelope other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder setBefore(debezium.hotel.booking_outbox.Value value) {
     ...
     * @return This builder.
     */
    public debezium.hotel.booking_outbox.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(debezium.hotel.booking_outbox.Value.newBuilder(before));
        } else {
          setBeforeBuilder(debezium.hotel.booking_outbox.Value.newBuilder());
        }
      }
    ...
    public debezium.hotel.booking_outbox.Envelope.Builder setBeforeBuilder(debezium.hotel.booking_outbox.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder setAfter(debezium.hotel.booking_outbox.Value value) {
     ...
     * @return This builder.
     */
    public debezium.hotel.booking_outbox.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(debezium.hotel.booking_outbox.Value.newBuilder(after));
        } else {
          setAfterBuilder(debezium.hotel.booking_outbox.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public debezium.hotel.booking_outbox.Envelope.Builder setAfterBuilder(debezium.hotel.booking_outbox.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder setSource(io.debezium.connector.postgresql.Source value) {
    ...
    public debezium.hotel.booking_outbox.Envelope.Builder setSourceBuilder(io.debezium.connector.postgresql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder setOp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder setTransaction(event.block value) {
    ...
    public debezium.hotel.booking_outbox.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public debezium.hotel.booking_outbox.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (debezium.hotel.booking_outbox.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (debezium.hotel.booking_outbox.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new debezium.hotel.booking_outbox.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new debezium.hotel.booking_outbox.Value();
        }
